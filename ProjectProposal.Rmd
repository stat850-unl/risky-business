...
drop qnchokeself qncigschool qnchewtobschool qnalcoholschool qntypealcohol2 qnhowmaraijuana qnmaraijuanaschool;
run;
...
*/Also misspelled two earler qn codes./*
data stat850.yrs23; set stat850.yrs22;
drop sitecode sitename sitetypenum qnhowmarijuana qnmarijuanaschool;
run;
...
```{r}
yrisk <- read.csv("https://github.com/stat850-unl/risky-business/blob/master/yrs24.csv", header = TRUE, sep = ",")
```
